...
- `pnpm build` succeeds
- `pnpm test` succeeds
- `pnpm compat:local:evm` succeeds against a running `api-server-onchain`
- `pnpm smoke:local:solana` succeeds when validating Solana support with a funded Solana payer
